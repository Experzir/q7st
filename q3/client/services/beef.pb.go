...
type BeefResponse struct {
	...
	Beef []byte `protobuf:"bytes,1,opt,name=beef,proto3" json:"beef,omitempty"` // map<string, int64> beefs = 2;
}
...
func (x *BeefResponse) GetBeef() []byte {
	if x != nil {
		return x.Beef
	}
	return nil
...
var file_beef_proto_rawDesc = []byte{
	...
	0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x22, 0x0a, 0x0c, 0x42, 0x65, 0x65, 0x66, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x62, 0x65, 0x65, 0x66, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0c, 0x52, 0x04, 0x62, 0x65, 0x65, 0x66, 0x32, 0x42, 0x0a, 0x04, 0x42, 0x65, 0x65,
	0x66, 0x12, 0x3a, 0x0a, 0x09, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x65, 0x65, 0x66, 0x12, 0x15,
...
var file_beef_proto_depIdxs = []int32{
	0, // 0: services.Beef.CountBeef:input_type -> services.BeefRequest
	1, // 1: services.Beef.CountBeef:output_type -> services.BeefResponse
